...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */`;var{h:ke,classNames:ic,createRef:ft}=omii,_,le,X,Ye,Ze,go,Ne=class extends g{constructor(){super(...arguments);m(this,_,ft());m(this,le,ft());m(this,X,ft());m(this,Ye,ft());m(this,Ze,ft());m(this,go,ft())}close(e,o){}closeFooter(){this.$props.openFooter=!1,B.collapse.hide(c(this,X).current),c(this,le).current.style.height=this.clientHeight-c(this,_).current.clientHeight+"px"}openFooter(){this.$props.openFooter=!0,B.collapse.show(c(this,X).current),c(this,le).current.style.height=this.clientHeight-c(this,_).current.clientHeight-c(this,X).current.scrollHeight+"px"}toggleFooter(){this.$props.openFooter?this.closeFooter():this.openFooter()}closeHeader(){this.$props.openHeader=!1,B.collapse.hide(c(this,_).current),c(this,le).current.style.height=this.clientHeight-c(this,X).current.clientHeight+"px"}openHeader(){this.$props.openHeader=!0,B.collapse.show(c(this,_).current),c(this,le).current.style.height=this.clientHeight-c(this,_).current.scrollHeight-c(this,X).current.clientHeight+"px"}toggleHeader(){this.$props.openHeader?this.closeHeader():this.openHeader()}closeLeft(){this.$props.openLeft=!1,B.collapse.hide(c(this,Ye).current)}openLeft(){this.$props.openLeft=!0,B.collapse.show(c(this,Ye).current)}toggleLeft(){this.$props.openLeft?this.closeLeft():this.openLeft()}closeRight(){this.$props.openRight=!1,B.collapse.hide(c(this,Ze).current)}openRight(){this.$props.openRight=!0,B.collapse.show(c(this,Ze).current)}toggleRight(){this.$props.openRight?this.closeRight():this.openRight()}resize(){let e=this.getBoundingClientRect(),o=c(this,_).current.getBoundingClientRect(),i=c(this,X).current.getBoundingClientRect();c(this,le).current.style.height=e.height-o.height-i.height+"px"}installed(){let{openFooter:e,openHeader:o,openLeft:i,openRight:s}=this.$props;e||(c(this,X).current.style.height=0),o||(c(this,_).current.style.height=0),i||(c(this,Ye).current.style.height=0),s||(c(this,Ze).current.style.height=0),this.resize(),window.addEventListener("resize",r=>{this.resize()},!0)}render(e){return ke(ke.f,null,ke("slot",{name:"header",ref:c(this,_)}),ke("main",{ref:c(this,le)},ke("slot",{name:"left",ref:c(this,Ye),class:"collapse-horizontal"}),ke("slot",{name:"content",ref:c(this,go)}),ke("slot",{name:"right",ref:c(this,Ze),class:"collapse-horizontal"})),ke("slot",{name:"footer",ref:c(this,X)}))}};_=new WeakMap,le=new WeakMap,X=new WeakMap,Ye=new WeakMap,Ze=new WeakMap,go=new WeakMap,l(Ne,"css",[Zi]),l(Ne,"defaultProps",{openFooter:!0,openHeader:!0,openLeft:!0,openRight:!0,duration:.35}),l(Ne,"propTypes",{openFooter:Boolean,openHeader:Boolean,openLeft:Boolean,openRight:Boolean});var Ki=`
:host {
  display: block;
  width: 100%;
  height: 100%;
