var Ci=Object.defineProperty;var Ii=Object.getPrototypeOf;var Vi=Reflect.get;var $i=(t,e,o)=>e in t?Ci(t,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[e]=o;var c=(t,e,o)=>($i(t,typeof e!="symbol"?e+"":e,o),o),_t=(t,e,o)=>{if(!e.has(t))throw TypeError("Cannot "+o)};var d=(t,e,o)=>(_t(t,e,"read from private field"),o?o.call(t):e.get(t)),m=(t,e,o)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,o)},g=(t,e,o,i)=>(_t(t,e,"write to private field"),i?i.call(t,o):e.set(t,o),o);var Ft=(t,e,o)=>(_t(t,e,"access private method"),o),Ge=(t,e,o)=>Vi(Ii(t),o,e);var{define:Zs,h:Gs,Component:Di}=omii,h=class extends Di{};var No=`
:host {
  height: 100%;
  display: block;
}
...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VSb290IjoiRDpcXEdJVFxcb21paS11aVxcc3JjXFxpbXBvcnQiLCJzb3VyY2VzIjpbImluZGV4LnNjc3MiXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IkFBQUE7RUFDSTs7QUFDQTtFQUNJO0VBQ0EifQ== */`;var{h:Uo,classNames:il,uniqueTag:Hs}=omii,Le,xe=class extends h{constructor(){super(...arguments);m(this,Le,void 0)}load(e,o="default",i=Uo("oi-loading",{size:"6"})){g(this,Le,i),e&&o&&import(e).then(s=>{let r=s[o];if(typeof r=="function"){let a=Hs(r);g(this,Le,Uo(a,null))}else g(this,Le,r);this.updateSelf()}).catch(s=>{console.error("import module error\uFF01",e,o,s)})}install(){let{src:e,module:o,loading:i}=this.$props;this.load(e,o,i)}render(e){return d(this,Le)}};Le=new WeakMap,c(xe,"css",[Ri]),c(xe,"defaultProps",{src:null,module:"default",loading:Uo("oi-loading",{size:"6"})}),c(xe,"propTypes",{src:String,module:String});var Ni=`
:host {
  display: block;
  width: fit-content;
}
...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VSb290IjoiRDpcXEdJVFxcb21paS11aVxcc3JjXFxjb2RlciIsInNvdXJjZXMiOlsiaW5kZXguc2NzcyJdLCJuYW1lcyI6W10sIm1hcHBpbmdzIjoiQUFBQTtFQUNJO0VBQ0E7RUFDQTs7QUFFQTtFQUNJO0VBQ0E7RUFDQSJ9 */`;var{h:_s,Component:Ol}=omii,Wt,Be=class extends h{constructor(){super(...arguments);m(this,Wt,void 0)}get value(){return this.editor?.getValue()}set value(e){this.editor?.setValue(e)}installed(){let{codes:e,language:o,automaticLayout:i,fontSize:s}=this.$props;import(new URL("./monaco/index.js",import.meta.url).href).then(({monaco:r})=>{g(this,Wt,r),this.editor=r.editor.create(this.$(".coder"),{value:e,language:o,automaticLayout:i,fontSize:s,minimap:{enabled:!1}})})}render(){return _s("div",{class:"coder"})}};Wt=new WeakMap,c(Be,"css",[()=>{let e=import.meta.url,o=`@font-face {
      ...
      }`,i=new CSSStyleSheet;return i.replace(o),document.adoptedStyleSheets=[...document.adoptedStyleSheets,i],fetch(new URL("./monaco/index.css",e).href).then(s=>s.text())},Ei]),c(Be,"defaultProps",{codes:"",language:"javascript",automaticLayout:!0,fontSize:12}),c(Be,"propTypes",{codes:String,language:String,fontSize:Number,automaticLayout:Boolean});var{define:S}=omii;S("oi-rate",oe);S("oi-tab",te);S("oi-icon",$);S("oi-pager",P);S("oi-tree",re);S("oi-loading",_);S("oi-alert",ae);S("oi-accordion",ne);S("oi-breadcrumb",le);S("oi-modal",ce);S("oi-popover",M);S("oi-uploader",pe);S("oi-carousel",ue);S("oi-badge",he);S("oi-toast",me);S("oi-progress",be);S("oi-tooltip",Ee);S("oi-layout",ye);S("oi-import",xe);S("oi-offcanvas",Se);S("oi-pagination",se);S("oi-dropdown",Fe);S("oi-coder",Be);customElements.define("oi-form",q,{extends:"form"});var Ys=import.meta.url;omii.ui={utils:zo,vision:gi,css:Vo,effect:B,icon:$,tab:te,rate:oe,pager:P,tree:re,treeNode:oo,loading:_,alert:ae,accordion:ne,breadcrumb:le,modal:ce,popover:M,uploader:pe,carousel:ue,badge:he,toast:me,progress:be,tooltip:Ee,layout:ye,import:xe,offcanvas:Se,pagination:se,form:q,dropdown:Fe,coder:Be,importURL:Ys};export{ne as accordion,ae as alert,le as breadcrumb,ue as carousel,Be as coder,Vo as css,Fe as dropdown,B as effect,q as form,$ as icon,xe as import,Ys as importURL,ye as layout,_ as loading,ce as modal,Se as offcanvas,P as pager,se as pagination,M as popover,be as progress,oe as rate,te as tab,me as toast,Ee as tooltip,re as tree,oo as treeNode,pe as uploader,zo as utils,gi as vision};
