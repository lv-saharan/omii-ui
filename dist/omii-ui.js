...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */`;var{h:gt,Component:Ar,classNames:ts,render:Mr}=omii,de=class extends g{get activeIndex(){return this.$props.activeIndex??0}get activeKey(){return this.$props.activeKey}async active({index:t,key:e},o=null){(o==null||o==this.$props.activeEvent)&&(this.activeKey?this.update$Props({activeKey:e},{ignoreAttrs:!0,updateSelf:!0}):this.update$Props({activeIndex:t},{ignoreAttrs:!0,updateSelf:!0}))}async render(t){let e=this.$props,o=t.items??e.items,s=[],i=[];for(let r=0;r<(o??[]).length;r++){let a=o[r],n=this.activeKey?this.activeKey==a.key:r==this.activeIndex,d=a.pane;i.push(gt("div",{key:`pane-${a.key??r}`,className:ts("pane",{active:n})},d)),s.push(gt("div",{key:`nav-${a.key??r}`,className:ts("nav",{active:n}),onMouseEnter:()=>this.active({index:r,key:a.key},"hover"),onclick:()=>this.active({index:r,key:a.key},"click")},a.nav??a.name??a.key))}return gt("div",{class:"tabs"},gt("div",{class:"navs"},s),gt("div",{class:"panes"},i))}};l(de,"css",es),l(de,"defaultProps",{activeIndex:null,activeKey:null,activeEvent:"click"}),l(de,"propTypes",{activeIndex:Number,activeKey:String,activeEvent:String});var Je={BUNDLE:"bundle",SINGLE:"single"},bt={FILLED:"filled",OUTLINED:"outlined",ROUND:"round",SHARP:"sharp",TWO_TONE:"two-tone",FILE_TYPE:"file-type"};var{define:Hr,h:os,Component:Yr}=omii,vt=Je.SINGLE,So=bt.FILLED,Fo=async(t,e,o)=>{e=e??So,e==bt.FILE_TYPE&&(o=Je.BUNDLE);try{if((o??vt)==Je.BUNDLE){let{default:s}=await import(`./icons/${e}.js`);return s[t]}else{let{default:s}=await import(`./icons/${e}/${t}.js`);return s}}catch{console.error("load icon error",t,e)}},Ti=async(t,e,o,s={})=>{let i=await Fo(t,e,o);return os("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",part:"svg",...s},i)},P=class extends g{static useBundleMode(){vt=Je.BUNDLE}static useSingleMode(){vt=Je.SINGLE}static get MODES(){return Je}static get TYPES(){return bt}static get Mode(){return vt}static set Mode(t){vt=t}static get Type(){return So}static set Type(t){So=t}css(){let{size:t,color:e}=this.$props,o=e||"var(--oi-icon-color)",s=t?`${t}rem`:"var(--oi-icon-width, 1rem)",i=t?`${t}rem`:"var(--oi-icon-height, 1rem);";return`
  ...
  `);var{h:ss}=omii,Bo=async t=>{try{let{default:e}=await import(`./bootstrap/icons/${t}.js`);return e}catch{console.error("load icon error",t,type)}},Li=async(t,e={})=>{let o=await Bo(t);return ss("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",part:"svg",...e},o)},W=class extends g{css(){let{size:t,color:e}=this.$props,o=e||"var(--oi-bi-color)",s=t?`${t}rem`:"var(--oi-bi-width, 1rem)",i=t?`${t}rem`:"var(--oi-bi-height, 1rem);";return`
      :host svg{
        fill: ${o} ;
        width: ${s};
        height: ${i};
      }
    `}async render(){let{name:t,viewBox:e}=this.$props,o=await Bo(t);return ss("svg",{part:"svg",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 "+e+" "+e},o)}};l(W,"updateOnAttributeChanged",!0),l(W,"propTypes",{name:String,viewBox:Number,size:Number,color:String}),l(W,"defaultProps",{name:null,viewBox:16,size:null,color:null}),l(W,"createSvg",Li),l(W,"loadIcon",Bo),l(W,"css",`
    :host{
...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VSb290IjoiRDpcXGdpdFxcb21paS11aVxcc3JjXFxyYXRlIiwic291cmNlcyI6WyJpbmRleC5zY3NzIl0sIm5hbWVzIjpbXSwibWFwcGluZ3MiOiJBQUNLO0VBQ0kifQ== */`;var{define:aa,h:Uo,Component:na,classNames:Ci,render:la}=omii,Qo={STAR:"star",HALF:"star_half",BORDER:"star_border"},H,pe=class extends g{constructor(){super(...arguments);m(this,H,-1)}get rateScore(){return this.$props.score}install(){f(this,H,this.$props.score)}rate(e){this.fire("rate",e),f(this,H,e),this.update$Props({score:e})}render(e){let o=this.$props,{maxScore:s,rateable:i,size:r,color:a}=o,n=[],d=c(this,H);for(let p=0;p<s;p++)d-p>=.5?n.push(Qo.STAR):d-p>0?n.push(Qo.HALF):n.push(Qo.BORDER);return Uo("div",{class:Ci("rate-wrap","rate-"+c(this,H))},n.map((p,h)=>i?Uo("oi-icon",{name:p,size:r,color:a,className:p,onmouseenter:u=>{u.preventDefault(),u.stopPropagation(),f(this,H,h+1),this.fire("tryRate",c(this,H)),this.lazyUpdate()},onmouseleave:u=>{u.preventDefault(),u.stopPropagation(),f(this,H,this.rateScore),this.lazyUpdate()},onclick:u=>{u.preventDefault(),u.stopPropagation(),this.rate(h+1)}}):Uo("oi-icon",{name:p,size:r,color:a,className:p})))}};H=new WeakMap,l(pe,"css",is),l(pe,"defaultProps",{rateable:!1,maxScore:5,score:0,color:null,size:1}),l(pe,"propTypes",{rateable:Boolean,maxScore:Number,score:Number,size:Number,color:String});var rs=`
:host {
  display: block;
}
...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */`;var{h:Re,classNames:Dl,createRef:pt}=omii,M,ae,_,Ye,Ke,uo,ke=class extends g{constructor(){super(...arguments);m(this,M,pt());m(this,ae,pt());m(this,_,pt());m(this,Ye,pt());m(this,Ke,pt());m(this,uo,pt())}close(e,o){}closeFooter(){this.$props.openFooter=!1,U.collapse.hide(c(this,_).current),c(this,ae).current.style.height=this.clientHeight-c(this,M).current.clientHeight+"px"}openFooter(){this.$props.openFooter=!0,U.collapse.show(c(this,_).current),c(this,ae).current.style.height=this.clientHeight-c(this,M).current.clientHeight-c(this,_).current.scrollHeight+"px"}toggleFooter(){this.$props.openFooter?this.closeFooter():this.openFooter()}closeHeader(){this.$props.openHeader=!1,U.collapse.hide(c(this,M).current),c(this,ae).current.style.height=this.clientHeight-c(this,_).current.clientHeight+"px"}openHeader(){this.$props.openHeader=!0,U.collapse.show(c(this,M).current),c(this,ae).current.style.height=this.clientHeight-c(this,M).current.scrollHeight-c(this,_).current.clientHeight+"px"}toggleHeader(){this.$props.openHeader?this.closeHeader():this.openHeader()}closeLeft(){this.$props.openLeft=!1,U.collapse.hide(c(this,Ye).current)}openLeft(){this.$props.openLeft=!0,U.collapse.show(c(this,Ye).current)}toggleLeft(){this.$props.openLeft?this.closeLeft():this.openLeft()}closeRight(){this.$props.openRight=!1,U.collapse.hide(c(this,Ke).current)}openRight(){this.$props.openRight=!0,U.collapse.show(c(this,Ke).current)}toggleRight(){this.$props.openRight?this.closeRight():this.openRight()}resize(){let e=this.getBoundingClientRect(),o=c(this,M).current.getBoundingClientRect(),s=c(this,_).current.getBoundingClientRect();c(this,ae).current.style.height=e.height-o.height-s.height+"px"}installed(){let{openFooter:e,openHeader:o,openLeft:s,openRight:i}=this.$props;e||(c(this,_).current.style.height=0),o||(c(this,M).current.style.height=0),s||(c(this,Ye).current.style.height=0),i||(c(this,Ke).current.style.height=0),this.resize(),window.addEventListener("resize",r=>{this.resize()},!0)}render(e){return Re(Re.f,null,Re("slot",{name:"header",ref:c(this,M)}),Re("main",{ref:c(this,ae)},Re("slot",{name:"left",ref:c(this,Ye),class:"collapse-horizontal"}),Re("slot",{name:"content",ref:c(this,uo)}),Re("slot",{name:"right",ref:c(this,Ke),class:"collapse-horizontal"})),Re("slot",{name:"footer",ref:c(this,_)}))}};M=new WeakMap,ae=new WeakMap,_=new WeakMap,Ye=new WeakMap,Ke=new WeakMap,uo=new WeakMap,l(ke,"css",[_s]),l(ke,"defaultProps",{openFooter:!0,openHeader:!0,openLeft:!0,openRight:!0,duration:.35}),l(ke,"propTypes",{openFooter:Boolean,openHeader:Boolean,openLeft:Boolean,openRight:Boolean});var Xs=`
:host {
  display: block;
  width: 100%;
  height: 100%;
...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VSb290IjoiRDpcXGdpdFxcb21paS11aVxcc3JjXFxpbXBvcnQiLCJzb3VyY2VzIjpbImluZGV4LnNjc3MiXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IkFBQUE7RUFDSTtFQUNBO0VBQ0E7RUFDQTs7QUFFQTtFQUNJO0VBQ0E7RUFDQTtFQUNBO0VBQ0EifQ== */`;var{h:Ko,classNames:Wl,uniqueTag:Ur}=omii,ee,Ne=class extends g{constructor(){super(...arguments);m(this,ee,void 0)}get $module(){return c(this,ee)}load(e,o,s,i){o=o??this.$props.module,s=s??this.$props.loading,i=i??this.$props.loadError,f(this,ee,s),e&&o&&import(e).then(r=>{let a=r[o];if(a==null)f(this,ee,i);else if(typeof a=="function"){let n=Ur(a);f(this,ee,Ko(n,null))}else f(this,ee,a);this.updateSelf()}).catch(r=>{console.error("import module error\uFF01",e,o,r),f(this,ee,i),this.updateSelf()})}install(){let{src:e,module:o,loading:s,loadError:i}=this.$props;this.load(e,o,s,i)}render(e){return c(this,ee)}};ee=new WeakMap,l(Ne,"css",[Xs]),l(Ne,"defaultProps",{src:null,module:"default",loading:Ko("oi-loading",{size:"6"}),loadError:Ko("h1",null,"Module Load Error")}),l(Ne,"propTypes",{src:String,module:String});var Ws=`
:host {
  display: block;
  width: fit-content;
}
...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VSb290IjoiRDpcXGdpdFxcb21paS11aVxcc3JjXFxlY2hhcnRzIiwic291cmNlcyI6WyJpbmRleC5zY3NzIl0sIm5hbWVzIjpbXSwibWFwcGluZ3MiOiJBQUFBO0VBQ0k7RUFDQTtFQUNBO0VBQ0E7O0FBRUE7RUFDSTtFQUNBO0VBQ0EifQ== */`;var{h:Or,classNames:Wc,extractClass:Hc}=omii,di=new URL("./echarts/",import.meta.url).href,pi="echarts.esm.min.js",Jt,Ve=class extends g{constructor(){super(...arguments);m(this,Jt,void 0)}static get root(){return di}static set root(e){di=e}static get jsFile(){return pi}static set jsFile(e){pi=e}get echart(){return c(this,Jt)}async installed(){let e=await import(new URL(this.constructor.jsFile,this.constructor.root).href);f(this,Jt,e.init(this.$("main"))),this.draw()}draw(){this.echart.setOption(this.$props)}updated(){this.draw()}render(){return Or("main",null)}};Jt=new WeakMap,l(Ve,"css",ci),l(Ve,"propTypes",{}),l(Ve,"defaultProps",{title:null,tooltip:null,legend:[],xAxis:{},yAxis:{},series:[],width:null,height:null});var{define:w}=omii;w("oi-rate",pe);w("oi-tab",de);w("oi-icon",P);w("oi-bi",W);w("oi-pager",Y);w("oi-tree",he);w("oi-loading",oe);w("oi-alert",me);w("oi-accordion",ge);w("oi-breadcrumb",be);w("oi-modal",ve);w("oi-popover",q);w("oi-uploader",xe);w("oi-carousel",we);w("oi-badge",Fe);w("oi-toast",Be);w("oi-progress",Qe);w("oi-tooltip",He);w("oi-layout",ke);w("oi-import",Ne);w("oi-offcanvas",Te);w("oi-pagination",fe);w("oi-dropdown",Le);w("oi-coder",Ce);w("oi-select",Ee);w("oi-table",Ie);w("oi-tinymce",$e);w("oi-echarts",Ve);customElements.define("oi-form",ut,{extends:"form"});var Tr=import.meta.url;omii.ui={utils:Go,css:cs,effect:U,icon:P,tab:de,rate:pe,pager:Y,tree:he,treeNode:To,loading:oe,alert:me,accordion:ge,breadcrumb:be,modal:ve,popover:q,uploader:xe,carousel:we,badge:Fe,toast:Be,progress:Qe,tooltip:He,layout:ke,import:Ne,offcanvas:Te,pagination:fe,form:ut,dropdown:Le,coder:Ce,select:Ee,table:Ie,importURL:Tr,sortable:tt,tinymce:$e,echarts:Ve};export{ge as accordion,me as alert,W as bicon,be as breadcrumb,we as carousel,Ce as coder,cs as css,Le as dropdown,Ve as echarts,U as effect,ut as form,P as icon,Ne as import,Tr as importURL,ke as layout,oe as loading,ve as modal,Te as offcanvas,Y as pager,fe as pagination,q as popover,Qe as progress,pe as rate,Ee as select,tt as sortable,de as tab,Ie as table,$e as tinymce,Be as toast,He as tooltip,he as tree,To as treeNode,xe as uploader,Go as utils};
