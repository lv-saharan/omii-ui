...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */`;var{h:qe,Component:sr,classNames:To,render:rr}=omii,te=class extends h{get activeIndex(){return this.$props.activeIndex??0}get activeKey(){return this.$props.activeKey}async active({index:t,key:e},o=null){(o==null||o==this.$props.activeEvent)&&(this.activeKey?this.update$Props({activeKey:e},!0,!0):this.update$Props({activeIndex:t},!0,!0))}async render(t){let e=this.$props,o=t.items??e.items,i=[],s=[];for(let r=0;r<(o??[]).length;r++){let a=o[r],n=this.activeKey?this.activeKey==a.key:r==this.activeIndex,l=a.pane;s.push(qe("div",{key:`pane-${a.key??r}`,className:To("pane",{active:n})},l)),i.push(qe("div",{key:`nav-${a.key??r}`,className:To("nav",{active:n}),onMouseEnter:()=>this.active({index:r,key:a.key},"hover"),onclick:()=>this.active({index:r,key:a.key},"click")},a.nav??a.name??a.key))}return qe("div",{class:"tabs"},qe("div",{class:"navs"},i),qe("div",{class:"panes"},s))}};c(te,"css",Qo),c(te,"defaultProps",{activeIndex:null,activeKey:null,activeEvent:"click"}),c(te,"propTypes",{activeIndex:Number,activeKey:String,activeEvent:String});var Re={BUNDLE:"bundle",SINGLE:"single"},et={FILLED:"filled",OUTLINED:"outlined",ROUND:"round",SHARP:"sharp",TWO_TONE:"two-tone",FILE_TYPE:"file-type"};var{define:cr,h:Oo,Component:dr}=omii,tt=Re.SINGLE,Yt=et.FILLED,Zt=async(t,e,o)=>{e=e??Yt,e==et.FILE_TYPE&&(o=Re.BUNDLE);try{if((o??tt)==Re.BUNDLE){let{default:i}=await import(`./icons/${e}.js`);return i[t]}else{let{default:i}=await import(`./icons/${e}/${t}.js`);return i}}catch{console.error("load icon error",t,e)}},zi=async(t,e,o,i={})=>{let s=await Zt(t,e,o);return Oo("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",part:"svg",...i},s)},D=class extends h{static useBundleMode(){tt=Re.BUNDLE}static useSingleMode(){tt=Re.SINGLE}static get MODES(){return Re}static get TYPES(){return et}static get Mode(){return tt}static set Mode(t){tt=t}static get Type(){return Yt}static set Type(t){Yt=t}css(){let{size:t,color:e}=this.$props,o=e||"var(--oi-icon-color)",i=t?`${t}rem`:"var(--oi-icon-width, 1rem)",s=t?`${t}rem`:"var(--oi-icon-height, 1rem);";return`
      :host svg{
        fill: ${o} ;
        width: ${i};
        height: ${s};
...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VSb290IjoiRDpcXOmhueebrlxcT01JSVxcdWlcXHNyY1xcY2Fyb3VzZWwiLCJzb3VyY2VzIjpbImluZGV4LnNjc3MiXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IkFBQUE7RUFDSTs7QUFFQTtFQUNJOztBQUlBO0VBQ0k7RUFDQTtFQUNBO0VBQ0E7RUFDQTtFQUNBO0VBQ0E7O0FBRUE7RUFDSSJ9 */`;var Cs="transitionend";var Si=t=>{t.dispatchEvent(new Event(Cs))},Is=t=>!t||typeof t!="object"?!1:(typeof t.jquery<"u"&&(t=t[0]),typeof t.nodeType<"u");var wi=t=>{if(!Is(t)||t.getClientRects().length===0)return!1;let e=getComputedStyle(t).getPropertyValue("visibility")==="visible",o=t.closest("details:not([open])");if(!o)return e;if(o!==t){let i=t.closest("summary");if(i&&i.parentNode!==o||i===null)return!1}return e};var{h:I,classNames:Bi,extractClass:$s}=omii;var Ds="carousel-item-end",Vs="carousel-item-start",zs="carousel-item-next",Js="carousel-item-prev",Ps=".active",As=".carousel-item",yn=Ps+As,ke,K,bt,fe,ue=class extends h{constructor(){super(...arguments);m(this,ke,0);m(this,K,!1);m(this,bt,[]);m(this,fe,void 0)}css(){return`
    .carousel-item {
      transition-duration: ${this.$props.duration}s;
    }
    `}get activeIndex(){return d(this,ke)}get isSliding(){return d(this,K)}get $items(){return this.$$(".carousel-item")}get $activeItem(){return this.$(".carousel-item.active")}pause(){d(this,K)&&Si(this),clearInterval(d(this,fe)),g(this,fe,null)}get indicators(){return[...this.$("slot[name=indicators]").children]}slide(e=!0){if(d(this,K))return!1;let{$activeItem:o,$items:i,$props:{duration:s}}=this,r=i.indexOf(o),a,n;if(e instanceof HTMLElement?(n=e,a=i.indexOf(n),e=a>r):typeof e=="number"?(a=(e+i.length)%i.length,n=i[a],e=a>r):(a=(r+1)%i.length,e||(a=(r-1+i.length)%i.length),n=i[a]),d(this,ke)==a)return!1;let l=e?Vs:Ds,p=e?zs:Js;g(this,K,!0);let f=Number.parseFloat(o.getAttribute("waiting"))??0;C(n,[{classNames:[],duration:f},{classNames:[p],callback:()=>{Ot(n)}},{classNames:[p,l],duration:s},{classNames:["active"],callback:()=>{this.indicators.forEach((u,b)=>{a==b?u.classList.add("active"):u.classList.remove("active")})}}]),C(o,[{classNames:[],duration:f},{classNames:[l,"active"],duration:s},{classNames:[],callback:()=>{g(this,K,!1),g(this,ke,a);let u;for(;u=d(this,bt).pop();)u()}}])}nextWhenVisible(){!document.hidden&&wi(this)&&this.slide()}cycle(){d(this,fe)&&clearInterval(d(this,fe)),g(this,fe,setInterval(()=>this.nextWhenVisible(),this.$props.interval*1e3))}installed(){let e=this.$items;!this.$activeItem&&e.length>0&&e[0].classList.add("active"),g(this,ke,e.indexOf(this.$activeItem)),this.$props.autoSlide&&this.$activeItem&&this.cycle(),this.addEventListener("mouseenter",()=>{this.pause()}),this.addEventListener("mouseleave",()=>{this.$props.autoSlide&&(d(this,K)?d(this,bt).push(()=>{this.cycle()}):this.cycle())})}render(e){let{items:o,nextCtrl:i,prevCtrl:s,indicator:r}=this.$props;return I("div",{...$s(e,"carousel")},I("slot",{class:"carousel-inner"},o.map(a=>I("div",{className:Bi("carousel-item"),waiting:a.attributes?.waiting},a))),I("div",{class:"carousel-indicators"},I("slot",{name:"indicators"},typeof r=="function"&&o.map((a,n)=>r({item:a,index:n,host:this})))),I("slot",{name:"actions"},typeof i=="function"&&i(this),typeof s=="function"&&s(this)))}};ke=new WeakMap,K=new WeakMap,bt=new WeakMap,fe=new WeakMap,c(ue,"css",[()=>y("reboot","utilities","carousel"),xi]),c(ue,"defaultProps",{autoSlide:!0,pauseEvent:"hover",interval:2.3,duration:.6,items:[],prevCtrl:e=>I("button",{class:"carousel-control-prev",type:"button",onClick:o=>{e.slide(!1)}},I("span",{class:"carousel-control-prev-icon","aria-hidden":"true"}),I("span",{class:"visually-hidden"},"Previous")),nextCtrl:e=>I("button",{class:"carousel-control-next",type:"button",onClick:o=>{e.slide()}},I("span",{class:"carousel-control-next-icon","aria-hidden":"true"}),I("span",{class:"visually-hidden"},"Next")),indicator:({index:e,host:o})=>I("button",{type:"button",onClick:i=>o.slide(e),class:Bi({active:e==0})})}),c(ue,"propTypes",{autoSlide:Boolean,interval:Number,duration:Number,pauseEvent:String});var{h:Bo,classNames:wn,extractClass:js}=omii,he=class extends h{css(){}render(t){let{text:e,desc:o,position:i}=this.$props,s=i?i.split("-"):[];return Bo("span",{...js(t,"badge",{"position-absolute":i,"top-0":s.includes("top"),"start-100":s.includes("right"),"start-0":s.includes("left"),"top-100":s.includes("bottom"),"translate-middle":i,"rounded-pill":i})},Bo("slot",null,e),o&&Bo("span",{class:"visually-hidden"},o))}};c(he,"css",()=>y("reboot","utilities","badge")),c(he,"defaultProps",{text:"",desc:!1,position:!1}),c(he,"propTypes",{});var Ni=`
:host slot[name=header] {
  display: block;
  flex: 1;
}
/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VSb290IjoiRDpcXOmhueebrlxcT01JSVxcdWlcXHNyY1xcdG9hc3QiLCJzb3VyY2VzIjpbImluZGV4LnNjc3MiXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IkFBQ0k7RUFDSTtFQUNBIn0= */`;var{h:Me,classNames:Qn,extractClass:Ms}=omii,ge,me=class extends h{constructor(){super(...arguments);m(this,ge,!0)}get closed(){return d(this,ge)}close(){g(this,ge,!0),N.fade.hide(this).then(()=>{this.update()})}show(){this.open()}open(){g(this,ge,!1),this.update(),N.fade.show(this)}install(){g(this,ge,!this.$props.visible)}render(e){return Me("div",{...Ms(e,"toast",{show:!d(this,ge)}),role:"alert","aria-live":"assertive","aria-atomic":"true"},Me("div",{class:"toast-header"},Me("slot",{name:"header"}),Me("button",{type:"button",class:"btn-close","aria-label":"Close",onClick:o=>{this.close()}})),Me("div",{class:"toast-body"},Me("slot",null)))}};ge=new WeakMap,c(me,"css",[()=>y("reboot","utilities","toasts","close"),Ni]),c(me,"defaultProps",{visible:!1}),c(me,"propTypes",{visible:Boolean});var{h:No,classNames:Hs,extractClass:In}=omii,be=class extends h{setValue(t){this.$props.value=value,this.update()}css(){}render(t){let{label:e,value:o,min:i,max:s,showPercent:r,striped:a,animated:n,style:l,className:p}=this.$props;return No("div",{class:"progress",style:l},No("div",{class:Hs("progress-bar",t.class??t.className,{"progress-bar-striped":a,"progress-bar-animated":n}),role:"progressbar","aria-label":e,style:{width:`${o}%`},"aria-valuenow":o,"aria-valuemin":i,"aria-valuemax":s},r&&No("span",null,o,"%")))}};c(be,"css",()=>y("reboot","utilities","progress")),c(be,"defaultProps",{label:!1,value:0,min:0,max:100,height:!1,showPercent:!1,striped:!1,animated:!1}),c(be,"propTypes",{label:String,value:Number,min:Number,max:Number,height:String,showPercent:Boolean,striped:Boolean,animated:Boolean});var Ri=`
:host {
  --oi-heading-color: black;
  position: relative;
}
...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VSb290IjoiRDpcXOmhueebrlxcT01JSVxcdWlcXHNyY1xcaW1wb3J0Iiwic291cmNlcyI6WyJpbmRleC5zY3NzIl0sIm5hbWVzIjpbXSwibWFwcGluZ3MiOiJBQUFBO0VBQ0k7O0FBQ0E7RUFDSTtFQUNBIn0= */`;var{h:Ro,classNames:il,uniqueTag:Xs}=omii,Ee,xe=class extends h{constructor(){super(...arguments);m(this,Ee,void 0)}load(e,o="default",i=Ro("oi-loading",{size:"6"})){g(this,Ee,i),e&&o&&import(e).then(s=>{let r=s[o];if(typeof r=="function"){let a=Xs(r);g(this,Ee,Ro(a,null))}else g(this,Ee,r);this.updateSelf()}).catch(s=>{console.error("import module error\uFF01",e,o,s)})}install(){let{src:e,module:o,loading:i}=this.$props;this.load(e,o,i)}render(e){return d(this,Ee)}};Ee=new WeakMap,c(xe,"css",[Fi]),c(xe,"defaultProps",{src:null,module:"default",loading:Ro("oi-loading",{size:"6"})}),c(xe,"propTypes",{src:String,module:String});var Qi=`
:host {
  display: block;
  width: fit-content;
}
