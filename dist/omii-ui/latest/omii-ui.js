...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VSb290IjoiRDpcXOmhueebrlxcT01JSVxcdWlcXHNyY1xcaW1wb3J0Iiwic291cmNlcyI6WyJpbmRleC5zY3NzIl0sIm5hbWVzIjpbXSwibWFwcGluZ3MiOiJBQUFBO0VBQ0k7O0FBQ0E7RUFDSTtFQUNBIn0= */`;var{h:Ws,classNames:sl,uniqueTag:_s}=omii,Ee,Xt,Qi,xe=class extends h{constructor(){super(...arguments);m(this,Xt);m(this,Ee,void 0)}install(){Ve(this,Xt,Qi).call(this)}render(e){return d(this,Ee)}};Ee=new WeakMap,Xt=new WeakSet,Qi=function(){let{src:e,module:o,loading:i}=this.$props;g(this,Ee,i),e&&o&&import(e).then(s=>{let r=s[o];r instanceof HTMLElement?g(this,Ee,_s(r)):g(this,Ee,r),this.updateSelf()}).catch(s=>{console.error("import module error\uFF01",e,o,s)})},c(xe,"css",[Fi]),c(xe,"defaultProps",{src:null,module:"default",loading:Ws("oi-loading",{size:"6"})}),c(xe,"propTypes",{src:String,module:String});var Ti=`
:host {
  display: block;
  width: fit-content;
}
...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VSb290IjoiRDpcXOmhueebrlxcT01JSVxcdWlcXHNyY1xcY29kZXIiLCJzb3VyY2VzIjpbImluZGV4LnNjc3MiXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IkFBQUE7RUFDSTtFQUNBO0VBQ0E7O0FBRUE7RUFDSTtFQUNBO0VBQ0EifQ== */`;var{h:Zs,Component:kl}=omii,_t,Ne=class extends h{constructor(){super(...arguments);m(this,_t,void 0)}get value(){return this.editor?.getValue()}set value(e){this.editor?.setValue(e)}installed(){let{codes:e,language:o,automaticLayout:i,fontSize:s}=this.$props;import(new URL("./monaco/index.js",import.meta.url).href).then(({monaco:r})=>{g(this,_t,r),this.editor=r.editor.create(this.$(".coder"),{value:e,language:o,automaticLayout:i,fontSize:s,minimap:{enabled:!1}})})}render(){return Zs("div",{class:"coder"})}};_t=new WeakMap,c(Ne,"css",[()=>{let e=import.meta.url,o=`@font-face {
        font-family: "codicon";
        font-display: block;
        src: url(${new URL("./monaco",e).href}/codicon-BEBTMDKB.ttf) format("truetype");
      }`,i=new CSSStyleSheet;return i.replace(o),document.adoptedStyleSheets=[...document.adoptedStyleSheets,i],fetch(new URL("./monaco/index.css",e).href).then(s=>s.text())},Ei]),c(Ne,"defaultProps",{codes:"",language:"javascript",automaticLayout:!0,fontSize:12}),c(Ne,"propTypes",{codes:String,language:String,fontSize:Number,automaticLayout:Boolean});var{define:w}=omii;w("oi-rate",oe);w("oi-tab",te);w("oi-icon",D);w("oi-pager",A);w("oi-tree",re);w("oi-loading",_);w("oi-alert",ae);w("oi-accordion",ne);w("oi-breadcrumb",le);w("oi-modal",ce);w("oi-popover",M);w("oi-uploader",pe);w("oi-carousel",ue);w("oi-badge",he);w("oi-toast",me);w("oi-progress",be);w("oi-tooltip",Le);w("oi-layout",ye);w("oi-import",xe);w("oi-offcanvas",we);w("oi-pagination",se);w("oi-dropdown",Be);w("oi-coder",Ne);customElements.define("oi-form",q,{extends:"form"});omii.ui={utils:zo,vision:gi,css:$o,effect:N,icon:D,tab:te,rate:oe,pager:A,tree:re,treeNode:io,loading:_,alert:ae,accordion:ne,breadcrumb:le,modal:ce,popover:M,uploader:pe,carousel:ue,badge:he,toast:me,progress:be,tooltip:Le,layout:ye,import:xe,offcanvas:we,pagination:se,form:q,dropdown:Be,coder:Ne};export{ne as accordion,ae as alert,le as breadcrumb,ue as carousel,Ne as coder,$o as css,Be as dropdown,N as effect,q as form,D as icon,xe as import,ye as layout,_ as loading,ce as modal,we as offcanvas,A as pager,se as pagination,M as popover,be as progress,oe as rate,te as tab,me as toast,Le as tooltip,re as tree,io as treeNode,pe as uploader,zo as utils,gi as vision};
